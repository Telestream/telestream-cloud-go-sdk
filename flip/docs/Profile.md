...
**AspectMode** | **string** | Specifies an aspect mode for output videos. The following options are available:   - letterbox:   - pad: Add paddings to the input image. Default is \&quot;letterbox\&quot;. | [optional] [default to null]
**AspectRatio** | **string** | A display aspect ratio. By default it is not set. | [optional] [default to null]
**AudioBitrate** | **int32** | audio bitrate (in bits/s) | [optional] [default to null]
**AudioChannels** | **int32** | A number of audio channels. By default it is not set. | [optional] [default to null]
...
**AudioChannelsPerTrack** | **int32** | A number of audio channels per track. | [optional] [default to null]
**AudioCodec** | **string** | Audio codec that will be used by the profile. Available codecs are: &#x60;libmp3lame&#x60;, &#x60;libvorbis&#x60;, &#x60;libfdk_aac&#x60;, &#x60;dib_ac3, &#x60;pcm_s16le&#x60;, &#x60;mp2&#x60;, &#x60;ac3&#x60;, &#x60;eac3&#x60;. | [optional] [default to null]
...
**AudioProfile** | **string** | Specifies an audio profile. | [optional] [default to null]
**AudioSampleRate** | **string** | The number of samples of audio carried per second. | [optional] [default to null]
...
**Bumpers** | **string** |  | [optional] [default to null]
...
**ColorMetadata** | **bool** |  | [optional] [default to null]
**CreatedAt** | **string** | A date and time when the Profile has been created. | [optional] [default to null]
...
**Fps** | **string** | Null value copy the original fps. By default it is not set. | [optional] [default to null]
**FrameCount** | **string** | Evenly spaced number of generated screenshots. By default it is not set. | [optional] [default to null]
...
**Height** | **string** | Height in pixels. | [optional] [default to null]
...
**KeyframeInterval** | **string** | Adds a key frame every N frames. Default is 250, adds a key frame every 250 frames. | [optional] [default to null]
...
**Trailers** | **string** |  | [optional] [default to null]
...
**VideoBitrate** | **string** |  | [optional] [default to null]
...
**Width** | **string** | Width in pixels. | [optional] [default to null]
