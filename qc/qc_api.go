 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
func (a *QcApiService) CancelJob(ctx context.Context, project string, job string) ( *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/projects/{project}/jobs/{job}/cancel.json"
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param data 
 @return Job*/
func (a *QcApiService) CreateJob(ctx context.Context, project string, data JobData) (Job,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project}/jobs.json"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param job A unique identifier of a Job.
 @return Job*/
func (a *QcApiService) GetJob(ctx context.Context, project string, job string) (Job,  *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project}/jobs/{job}.json"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"job"+"}", fmt.Sprintf("%v", job), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param project A unique identifier of a Project.
 @return Project*/
func (a *QcApiService) GetProject(ctx context.Context, project string) (Project,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project}.json"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
...
func (a *QcApiService) ListJobs(ctx context.Context, project string, localVarOptionals map[string]interface{}) (JobsCollection,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param optional (nil or map[string]interface{}) with one or more of:
     @param "data" (Data1) 
 @return Project*/
func (a *QcApiService) ModifyProject(ctx context.Context, project string, localVarOptionals map[string]interface{}) (Project,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody interface{}
		localVarFileName string
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param job A unique identifier of a Job.
 @return Proxy*/
func (a *QcApiService) Proxy(ctx context.Context, project string, job string) (Proxy,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project}/jobs/{job}/proxy.json"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"job"+"}", fmt.Sprintf("%v", job), -1)
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @param job A unique identifier of a Job.
 @return */
func (a *QcApiService) RemoveJob(ctx context.Context, project string, job string) ( *http.Response, error) {
	var (
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @param project 
 @return */
func (a *QcApiService) RemoveProject(ctx context.Context, project string) ( *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody interface{}
		localVarFileName string
...
func (a *QcApiService) SignedUrls(ctx context.Context, project string, job string) (map[string]string,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project}/jobs/{job}/signed-urls.json"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"job"+"}", fmt.Sprintf("%v", job), -1)
...
func (a *QcApiService) UploadVideo(ctx context.Context, project string, videoUploadBody VideoUploadBody) (UploadSession,  *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody interface{}
		localVarFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/projects/{project}/upload.json"
	localVarPath = strings.Replace(localVarPath, "{"+"project"+"}", fmt.Sprintf("%v", project), -1)
