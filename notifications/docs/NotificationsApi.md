...
# **CreateSubscription**
> Subscription CreateSubscription(ctx, optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **serviceType** | **string**| Service type (qc, tts, flip) | 
 **type_** | **string**| Subscription type (email, webhook, sns, aeg, pubsub) | 
...
# **ModifySubscription**
> Subscription ModifySubscription(ctx, id, optional)
Modify subscription
...
------------- | ------------- | ------------- | -------------
 **id** | **string**|  | 
 **updateData** | [**UpdateData**](UpdateData.md)|  | 
