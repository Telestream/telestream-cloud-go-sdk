...
**AspectMode** | **string** | Specifies an aspect mode for output videos. The following options are available:   - preserve   - constrain   - letterbox   - pad   - fill (crop)   - stretch   - center Default is \&quot;letterbox\&quot;. | [optional] [default to null]
...
**CropInputWidth** | **float32** | Height of the cropped image in pixels. | [optional] [default to null]
